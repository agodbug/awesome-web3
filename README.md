...
- [Token Economy Book](https://github.com/sherminvo/TokenEconomyBook/wiki) - Explaining "How the Web3 reinvents the Internet".
- [The Book of Swarm](https://www.ethswarm.org/The-Book-of-Swarm.pdf) - Offering in-depth technical insights and high-level specifications for those seeking to understand or contribute to the Swarm project.
